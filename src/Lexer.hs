...
alex_base = Data.Array.listArray (0 :: Int, 74)
  [ -8
  , 0
  , 0
  , 70
...
alex_table = Data.Array.listArray (0 :: Int, 4323)
  [ 0
  , 47
  , 47
  , 23
...
alex_check = Data.Array.listArray (0 :: Int, 4323)
  [ -1
  , 9
  , 10
  , 39
...
alex_deflt = Data.Array.listArray (0 :: Int, 74)
  [ -1
  , -1
  , -1
  , -1
...
alex_accept = Data.Array.listArray (0 :: Int, 74)
  [ AlexAccNone
  , AlexAcc 69
  , AlexAcc 68
  , AlexAcc 67
...
alex_action_22 = \pos _ -> Token pos UNDER
alex_action_23 = \pos _ -> Token pos ASSIGN
alex_action_24 = \pos _ -> Token pos IN
alex_action_25 = \pos _ -> Token pos AS
alex_action_26 = \pos _ -> Token pos LET
alex_action_27 = \pos _ -> Token pos TYNAT
alex_action_28 = \pos _ -> Token pos TYBOOL
alex_action_29 = \pos _ -> Token pos TYUNIT
alex_action_30 = \pos s -> Token pos (NUM $ read s)
alex_action_31 = \pos s -> Token pos $ VAR s
alex_action_32 = \pos s -> Token pos $ ID s
